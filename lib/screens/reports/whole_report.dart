...
// class EmployeePeriodicReport extends StatefulWidget {
//   final Data user;

//   const EmployeePeriodicReport({
//     super.key,
//     required this.user,
//   });

//   @override
//   _EmployeePeriodicReportState createState() => _EmployeePeriodicReportState();
// }

// class _EmployeePeriodicReportState extends State<EmployeePeriodicReport> {
...
//     try {
//       final fetchedId = await UserPreferences().getUserStationId();
//       if (mounted) {
//         setState(() {
//           id = fetchedId;
//           Logger().i('User station ID: $id');
//           Logger().i('Employee ID: ${widget.user.id}');
//         });
//       }
//     } catch (e) {
...
//           url: Uri.parse(
//               '${ApiEndpoints.reportUrl}/personal_periodic_sales_report'
//               '?petrol_id=$id'
//               '&salesman=${widget.user.id}'
//               '&type=station'
//               '&from=${_dateFormat.format(fromDate!)}'
//               '&to=${_dateFormat.format(toDate!)}'),
//           headers: {
//             'Accept': '*/*',
...
//         centerTitle: false,
//         title: "${widget.user.fullname ?? ""} Report",
//       ),
//       body: Column(
//         children: [
//           Container(
